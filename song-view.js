...
showToast(`✅ Сет-лист «${sl.name}» отправлен на синхронизацию в команде`, 'success');
} catch (err) {
console.error('Team sync error:', err);
showToast('❌ Не удалось синхронизировать с командой: ' + err.message, 'error');
}
} else {
